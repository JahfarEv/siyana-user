...
function BranchSelectionModal({
  ...
  return (
<div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-md bg-white/30">      <motion.div
...
// ... (keep the existing SuccessModal component exactly as you have it)
